package com.example.Codility.features.posts.presentation
...
class PostViewModel @Inject constructor(
    private val getAllPostsUseCases: GetAllPostsUseCases
) : CoreViewModel() {

    val allItems = executeApi { getAllPostsUseCases.invoke() }.map { value ->
        when (value) {
